...
local character = 'characters/bfbeach' --put the name of the character's spritesheet here
...
local xleftoffs = 50 --X
local yleftoffs = 10 --Y

local xdownoffs = 25 --X
local ydownoffs = 50 --Y

local xupoffs = 50 --X
local yupoffs = -25 --Y

local xrightoffs = 0 --X
local yrightoffs = 10 --Y

--the poses in the xml

local idle = 'BF idle dance0' --idle

local left = 'BF NOTE RIGHT0' --left

local down = 'BF NOTE DOWN0' --down

local up = 'BF NOTE UP0' --up

local right = 'BF NOTE LEFT0' --right

--miss poses (optional)

local togglemisseanims = true --set this to true if you want miss animations, false to not


local leftmiss = 'BF NOTE LEFT MISS0' --left miss

local downmiss = 'BF NOTE DOWN MISS0' --down miss

local upmiss = 'BF NOTE UP MISS0' --up miss

local rightmiss = 'BF NOTE RIGHT MISS0' --right miss
