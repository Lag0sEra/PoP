	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Price of Progress'], 15);
					#else
					createCoolText(['was made by']);
					#end
				// credTextShit.visible = true;
				case 4:
					addMoreText('KirbyTheDemon', 15);
					addMoreText('Penove', 15);
					addMoreText('soul_', 15);
					addMoreText('CupODepresso', 15);
					addMoreText('LagosEra', 15);
					addMoreText('Brad', 15);
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['This is', 'a mod'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 8:
					addMoreText('about Pursuit', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Progress'); // credTextShit.text += '\nFunkin';
