...
class FlxClickableSprite extends FlxSprite
{
	...
	public override function new(x:Float, y:Float, spriteDir:String, ?onClick:Void->Void)
	{
		super(x, y);
		this.onClick = onClick;
		this.frames = Paths.getSparrowAtlas(spriteDir);
		this.animation.addByPrefix('idle', 'Item Idle', 24, true);
		this.animation.addByPrefix('hover', 'Item Hover', 24, true);
	}
